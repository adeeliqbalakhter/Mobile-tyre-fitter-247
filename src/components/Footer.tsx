            ...
            <div className="mt-4 flex items-center gap-3">
              {socialLinks.map(({ label, href, icon }) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 text-[#6a6a6a] transition-colors hover:border-[#d92a1d] hover:text-[#d92a1d] hover:bg-[#d92a1d]/5"
                >
                  {icon}
                </a>
              ))}
