...
const faqs = [
  ...
  { question: 'How much does mobile tyre fitting cost?', answer: 'Our pricing is transparent and competitive. The cost depends on your tyre size and brand choice. When you call us, we\'ll give you a clear, all-inclusive quote before any work begins, so you know exactly what you\'ll pay. We accept all major credit and debit cards.' },
  { question: 'Will my flat tyre need replacing?', answer: 'In the majority of cases, yes, a flat or damaged tyre will need to be replaced with a new one for your safety. We specialise in supplying and fitting replacement tyres at your location. Call us and we will bring the right replacement tyre to you.' },
