...
export default function FAQPage() {
  return (
    <>
      <SEOHead title="FAQs - Mobile Tyre Fitting Questions Answered" description="Frequently asked questions about our mobile tyre fitting service. 24/7 availability, pricing, coverage, brands, and more. Call 07933 899930 for immediate help." keywords="tyre fitting FAQ, mobile tyre questions, tyre fitting cost, 24/7 tyre service FAQ, tyre brands FAQ" schema={faqSchema} />
