...
const features = [
  ...
  "No premium charges for out-of-hours or weekend work",
...
const serviceFaqs = [
  ...
  { question: "Do you charge more at night or on weekends?", answer: "No. We do not charge any premium for out-of-hours, weekend, or bank holiday work. The price we quote is the same regardless of the time or day. Our pricing is based solely on the tyre and fitting work required." },
